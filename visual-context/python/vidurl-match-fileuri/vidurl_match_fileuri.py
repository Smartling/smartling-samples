...
CONTEXT_FILE_URL = 'https://downloads.smartling.com/smartlingsamples/video1.mp4'
CONTENT_FILE_NAME = 'vidurl-subtitles.srt'
JOB_NAME = 'vidurl-match-fileuri'
LOCALE_IDS = ['fr-FR']
AUTHORIZE = True
...
def main():
    ...
    multipart_request_data = {
            '': '' # to ensure Python 'requests' module sends correct content type
        }
