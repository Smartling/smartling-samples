...
This example also shows how a context file can be bound to a string even if the string doesn't appear in the context (the string 'some invisible content' in this case). When this is done, the context appears for the translator, but no string is highlighted.
