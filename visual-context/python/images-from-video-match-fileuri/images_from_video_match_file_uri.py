...
CONTEXT_FILE_NAME = 'images-from-video-match-fileuri-video1.mp4'
CONTENT_FILE_NAME = 'images-from-video-match-fileuri-contentfile1.json'
JOB_NAME = 'images-from-video-match-fileuri'
LOCALE_IDS = ['fr-FR']
AUTHORIZE = True
